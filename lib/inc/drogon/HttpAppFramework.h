...
class DROGON_EXPORT HttpAppFramework : public NonCopyable
{
  public:
     ...
     */
    [[nodiscard]] virtual EventLoop *getLoop() const = 0;
     ...
     */
    [[nodiscard]] virtual EventLoop *getIOLoop(size_t id) const = 0;
